...
typedef void *ptr_t;
// -------------------- regular printers --------------------
#define sprint_char(stream, val) sprintf(stream, "%c", val)
#define sprint_int(stream, val) sprintf(stream, "%d", val)
#define sprint_signed(stream, val) sprintf(stream, "%d", val)
#define sprint_unsigned(stream, val) sprintf(stream, "%u", val)
#define sprint_size_t(stream, val) sprintf(stream, "%zu", val)
#define sprint_ssize_t(stream, val) sprintf(stream, "%zd", val)
#define sprint_time_t(stream, val) sprintf(stream, "%lld", (long long)val)
#define sprint_ptrdiff_t(stream, val) sprintf(stream, "%0*tX", (int)(2 * sizeof(ptr_t)), val)
#define sprint_ptr_t(stream, val) sprintf(stream, "%0*tX", (int)(2 * sizeof(ptr_t)), (uintptr_t)val)
#define sprint_bool(stream, val) sprintf(stream, "%s", val ? "true" : " false")
#define sprint__Bool(stream, val) sprint_bool(stream, val)
#define sprint_uint8_t(stream, val) sprintf(stream, "%" PRIu8, val)
#define sprint_uint16_t(stream, val) sprintf(stream, "%" PRIu16, val)
#define sprint_uint32_t(stream, val) sprintf(stream, "%" PRIu32, val)
#define sprint_uint64_t(stream, val) sprintf(stream, "%" PRIu64, val)
#define sprint_int8_t(stream, val) sprintf(stream, "%" PRId8, val)
#define sprint_int16_t(stream, val) sprintf(stream, "%" PRId16, val)
#define sprint_int32_t(stream, val) sprintf(stream, "%" PRId32, val)
#define sprint_int64_t(stream, val) sprintf(stream, "%" PRId64, val)
#define sprint_float(stream, val) sprintf(stream, "%g", val)
#define sprint_double(stream, val) sprintf(stream, "%lg", val)
